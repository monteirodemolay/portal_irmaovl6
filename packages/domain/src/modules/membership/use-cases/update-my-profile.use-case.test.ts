...
describe('UpdateMyProfileUseCase', () => {
  it('atualiza o próprio subconjunto de campos de autoatendimento', async () => {
    ...
    // Regressão: fotoUrl não faz parte de `memberSelfEditSchema` (tem
    // caminho próprio, ver UpdateMyPhotoUseCase) e biografia/redesSociais
    // continuam só da edição administrativa — este Use Case nunca pode
    // sobrescrevê-los.
