...
export const BOARD_POSITION_KEYS = [
  ...
  'mestre_harmonia',
  'mestre_cerimonias',
  'mestre_cerimonias_adjunto',
  'instrutor_ritualistica_liturgia',
  'mestre_banquetes',
  'arquiteto_decorador',
  'porta_bandeira',
  'porta_espada',
...
export const BOARD_POSITION_LABELS: Record<BoardPositionKey, string> = {
  ...
  mestre_cerimonias_adjunto: 'Mestre de Cerimônias Adjunto',
  instrutor_ritualistica_liturgia: 'Instrutor de Ritualística e Liturgia',
  mestre_banquetes: 'Mestre de Banquetes',
  arquiteto_decorador: 'Arquiteto Decorador',
