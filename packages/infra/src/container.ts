import {
  ...
  UpdateMemberCentralProfileAssistedUseCase,
  RecordMemberProfileConsentUseCase,
  RevokeMemberProfileConsentUseCase,
  PublishMemberProfileBlocksUseCase,
  ...
  NotifyConnectedUsersOfNewVl6EventUseCase,
...
export function createServerContainer() {
  ...
  const useCases = {
    ...
    updateHeroPhoto: new UpdateHeroPhotoUseCase({
      tenantRepository: repositories.tenant,
      clock,
    }),
    ...
    verifyBirthdayData: new VerifyBirthdayDataUseCase({
      memberRepository: repositories.member,
      clock,
    }),
    ...
    updateMemberCentralProfileAssisted: new UpdateMemberCentralProfileAssistedUseCase({
      memberCentralProfileRepository: repositories.memberCentralProfile,
      memberRepository: repositories.member,
      auditLogRepository,
      clock,
    ...
    recordMemberProfileConsent: new RecordMemberProfileConsentUseCase({
      publicationConsentRepository: repositories.publicationConsent,
      memberRepository: repositories.member,
      auditLogRepository,
      clock,
    ...
    revokeMemberProfileConsent: new RevokeMemberProfileConsentUseCase({
      publicationSettingsRepository: repositories.publicationSettings,
      publicationConsentRepository: repositories.publicationConsent,
      memberRepository: repositories.member,
      auditLogRepository,
    ...
    publishMemberProfileBlocks: new PublishMemberProfileBlocksUseCase({
      publicationSettingsRepository: repositories.publicationSettings,
      publicationConsentRepository: repositories.publicationConsent,
      memberRepository: repositories.member,
      auditLogRepository,
    ...
    getBusinessDirectoryEntry: new GetBusinessDirectoryEntryUseCase({
      memberRepository: repositories.member,
      memberCentralProfileRepository: repositories.memberCentralProfile,
      publicationSettingsRepository: repositories.publicationSettings,
    }),
    ...
    notifyConnectedUsersOfNewVl6Event: new NotifyConnectedUsersOfNewVl6EventUseCase({
      connectionRepository: repositories.googleCalendarConnection,
      notificationRepository: repositories.notification,
    ...
    syncSpousesToParamasonicEntity: new SyncSpousesToParamasonicEntityUseCase({
      paramasonicEntityMemberRepository: repositories.paramasonicEntityMember,
      paramasonicEntityRepository: repositories.paramasonicEntity,
      memberRepository: repositories.member,
      clock,
