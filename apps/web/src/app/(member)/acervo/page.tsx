                  ...
                  result.kind === 'documento'
                    ...
                    : result.kind === 'biblioteca'
                      ...
                      : result.kind === 'fotografia'
                        ? GalleryIcon
                        : CalendarDays;
                // Foto própria do item — nunca uma foto de OUTRO registro do
                // grid (já confundiu Irmãos: parecia que aquela era a foto
                // daquele Evento específico). Sem foto própria, o card usa o
                // mesmo fundo azul-marinho institucional do resto da página
                // (hero, aside da Constelação), com o tipo e o ícone em
                // destaque — nunca fica "vazio", só não empresta imagem
                // alheia. Todo cartão do grid mantém o mesmo tamanho.
                return (
                  <Link
                  ...
                  >
                    <div className="border-border mb-3 aspect-video w-full shrink-0 overflow-hidden rounded-md border">
                      {result.imageUrl ? (
                        ...
                        <div className="from-primary to-primary-dark relative flex h-full w-full flex-col items-center justify-center gap-2 bg-gradient-to-br text-white">
                          <KindIcon className="text-accent" size={28} strokeWidth={1.4} />
