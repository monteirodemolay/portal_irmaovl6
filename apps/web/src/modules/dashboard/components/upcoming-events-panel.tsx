...
import { Badge, Card, Clock, MapPin, Sparkles } from '@vl6/ui';
...
/**
 * Lista compacta dos próximos Eventos da Loja (curso, palestra,
 * confraternização etc.) — equivalente a `AgendaPanel`, mas nunca mistura
 * Sessão: `events` já chega filtrado (`tipo !== 'sessao'`) e cortado no
 * tamanho pelo chamador.
 */
export function UpcomingEventsPanel({ events }: { events: Event[] }) {
  return (
