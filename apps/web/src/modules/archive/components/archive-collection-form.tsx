...
import { createArchiveCollectionAction, type ArchiveActionState } from '../actions/archive-actions';

const EMPTY_STATE: ArchiveActionState = { error: null };

export function ArchiveCollectionForm() {
  const [state, formAction] = useActionState(createArchiveCollectionAction, EMPTY_STATE);
